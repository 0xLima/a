    ...
    Pausable
{
    ...
    /// @dev for convienency this address is used to represent BNB just like ERC20
...
//        );
        ...
        if (collateralToken == nativeAddress) {
            ...
            ERC20(collateralToken)safe.TransferFrom(
                _msgSender(),
                address(this),
                collateralAmount
            );
...
/*/
        ...
        whenNotPaused
    {
        ...
        if (token == nativeAddress) {
            ...
            ERC20(token).safrTransfer(_msgSender(), amount);
        }
    ...
    function liquidateLoan(uint256 loanId) public nonReentrant {
        ...
        if (loan.currentCollateral >= (repaymentCollateral - fee)) {
            ...
            if (loan.currentCollateral >= repayment.Collateral) {
                collateralFee = fee;
            } else {
